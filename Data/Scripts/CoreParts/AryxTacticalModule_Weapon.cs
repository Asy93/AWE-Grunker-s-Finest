...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition AryxTacticalModule => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "ARYXTacticalModule",
            ...
            {
                PartName = "Aegis Tactical Module", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                {
                    RateOfFire = 1, // Set this to 3600 for beam weapons.
                    ...
                    HeatSinkRate = 17, // Amount of heat lost per second.
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "ArcWepShipARYX_TacticalModuleFire", // Audio for firing.
                    FiringSoundPerShot = true, // Whether to replay the sound for each shot, or just loop over the entire track while firing.
                    ReloadSound = "ArcWepShipARYX_TacticalModuleFire",
                    NoAmmoSound = "",
            ...
            Ammos = new[] {
                AryxTacticalModuleEMP, // Must list all primary, shrapnel, and pattern ammos.
            },
