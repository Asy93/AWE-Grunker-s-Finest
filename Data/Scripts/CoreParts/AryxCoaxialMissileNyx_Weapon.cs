...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition AryxSingleUseNyxHardpoint => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "ARYX_NyxMissileHardpoint",
            ...
            {
                PartName = "Nyx Missile Hardpoint", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
            ...
            Ammos = new[] {
                AryxNyxAmmo_Phasic_Stage1,
                AryxNyxAmmo_Phasic_Stage2,
            },
