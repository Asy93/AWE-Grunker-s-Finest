...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition AryxLightRailgunSmall => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "ARYXLightRailgun",
            ...
            {
                PartName = "Antaeus 115mm Railgun", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                {
                    RateOfFire = 260, // Set this to 3600 for beam weapons.
