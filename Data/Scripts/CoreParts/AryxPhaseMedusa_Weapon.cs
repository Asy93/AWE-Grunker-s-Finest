...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition AryxMedusaTurret => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "ARYXPhaseRepeaterCannon",
            ...
            {
                PartName = "Medusa Phase Cannon", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "ArcWepShipARYXMedusa_Fire", // Audio for firing.
                ...
                Graphics = new HardPointParticleDef
                {
                    ...
                    {
                        Name = "AryxAWE_Phase_MuzzleBlast", // SubtypeId of muzzle particle effect.
                        ...
                        Extras = new ParticleOptionDef
                        {
                            ...
                            MaxDistance = 2500, // Max distance at which this effect should be visible. NOTE: This will use whichever MaxDistance value is higher across Effect1 and Effect2!
