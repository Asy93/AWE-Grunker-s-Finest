...
namespace Scripts
{
    partial class Parts
    {
        ...
        WeaponDefinition AryxGravityGun => new WeaponDefinition
        {
            ...
            {
                PartName = "Graviton Tractor Beam", // name of weapon in terminal
