...
namespace Scripts
{
    partial class Parts
    {
        WeaponDefinition AryxLargeFlareLauncher => new WeaponDefinition
        {
            ...
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "ARYX_LargeFlareLauncher",
                        SpinPartId = "None",
                        MuzzlePartId = "None",
                        AzimuthPartId = "None",
            ...
            {
                PartName = "Large Flare Launcher", // name of weapon in terminal
            ...
            Ammos = new[] {
                ...
                AryxBlueFlareAmmo,
                AryxBlueFlareAmmoBurn,

                AryxGreenFlareAmmo,
                AryxGreenFlareAmmoBurn,
            },
