...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition AryxNucleonTurret => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "ARYXNucleonShotgun",
            ...
            {
                PartName = "Nucleon Laser Shotgun", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "ArcWepShipARYX_NucleonLaserFire", // Audio for firing.
                ...
                Graphics = new HardPointParticleDef
                {
                    ...
                    {
                        Name = "Aryx_Aurora_Muzzleflash", // SubtypeId of muzzle particle effect.
            ...
            Ammos = new[] {
                AryxNucleonLaserAmmo, // Must list all primary, shrapnel, and pattern ammos.
            },
            //Animations = Weapon75_Animation,
            //Upgrades = UpgradeModules,
        };
        WeaponDefinition AryxNucleonShotgunSG => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "AryxNucleonShotgun_SG",
                        SpinPartId = "None", // For weapons with a spinning barrel such as Gatling Guns.
            ...
            HardPoint = new HardPointDef
            {
                ...
                Loading = new LoadingDef
                {
                    RateOfFire = 400, // Set this to 3600 for beam weapons.
