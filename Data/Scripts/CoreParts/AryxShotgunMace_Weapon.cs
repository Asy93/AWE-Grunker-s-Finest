...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition AryxMaceShotgun => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        ...
                        DurabilityMod = 0.167f, // GeneralDamageMultiplier, 0.25f = 25% damage taken.
            ...
            {
                PartName = "Mace Combat Shotgun", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                HardWare = new HardwareDef
                {
                    ...
                    InventorySize = 0.360f, // Inventory capacity in kL.
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "ArcWepShipARYXMace_Fire", // Audio for firing.
                ...
                Graphics = new HardPointParticleDef
                {
                    ...
                    {
                        Name = "AWE_Mace_Muzzleblast", // SubtypeId of muzzle particle effect.
            ...
            Ammos = new[] {
                AryxShotgunAmmoWC, // Must list all primary, shrapnel, and pattern ammos.
            },
