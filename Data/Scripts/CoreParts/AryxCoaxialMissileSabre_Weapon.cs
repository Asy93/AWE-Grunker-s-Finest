...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition AryxSingleUseSabreHardpoint => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "ARYX_SabreMissileHardpoint",
            ...
            {
                PartName = "Sabre Missile Hardpoint", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
