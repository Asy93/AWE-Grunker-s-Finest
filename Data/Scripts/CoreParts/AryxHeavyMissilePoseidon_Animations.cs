...
{ // Don't edit above this line
    partial class Parts
    {
        private AnimationDef AryxFenrirAnims => new AnimationDef
        {
            ...
            {   //Region is used for organisation as it creates a collapsible tag.
                ...
                {
                    SubpartId = Names("fenrir_door_01"), //Remember to remove subpart_ from these names!
                               ...
                               new RelMove
                                {
                                    ...
                                    MovementType = Linear, //Linear,ExpoDecay,ExpoGrowth,Delay,Show, //instant or fade Hide, //instant or fade
                                    LinearPoints = new XYZ[0],
                                    Rotation = Transformation(-90f, 0, 0), //degrees
                                    RotAroundCenter = Transformation(0, 0, 0), //degrees
                                },
                            },
                    }
                ...
                new PartAnimationSetDef()
                {
                    SubpartId = Names("fenrir_torp_01"), //Remember to remove subpart_ from these names!
                    BarrelId = "muzzle_missile_1", //Trigger anim when this muzzle does something.
                    StartupFireDelay = 0, //Delay in ticks until anim starts.
                    AnimationDelays = Delays(FiringDelay: 0, ReloadingDelay: 0, OverheatedDelay: 0, TrackingDelay: 0, LockedDelay: 0, OnDelay: 0, OffDelay: 0, BurstReloadDelay: 0, OutOfAmmoDelay: 0, PreFireDelay: 0),//Delay before animation starts
                    Reverse = Events(),
                ...
                new PartAnimationSetDef()
                {
                    SubpartId = Names("fenrir_door_03"), //Remember to remove subpart_ from these names!
                ...
                new PartAnimationSetDef()
                {
                    SubpartId = Names("fenrir_torp_03"), //Remember to remove subpart_ from these names!
                    BarrelId = "muzzle_missile_3", //Trigger anim when this muzzle does something.
                    StartupFireDelay = 0, //Delay in ticks until anim starts.
                    AnimationDelays = Delays(FiringDelay: 0, ReloadingDelay: 0, OverheatedDelay: 0, TrackingDelay: 0, LockedDelay: 0, OnDelay: 0, OffDelay: 0, BurstReloadDelay: 0, OutOfAmmoDelay: 0, PreFireDelay: 0),//Delay before animation starts
                    Reverse = Events(),
                ...
                new PartAnimationSetDef()
                {
                    SubpartId = Names("fenrir_door_02"), //Remember to remove subpart_ from these names!
                ...
                new PartAnimationSetDef()
                {
                    SubpartId = Names("fenrir_torp_02"), //Remember to remove subpart_ from these names!
                    BarrelId = "muzzle_missile_2", //Trigger anim when this muzzle does something.
                    StartupFireDelay = 0, //Delay in ticks until anim starts.
                    AnimationDelays = Delays(FiringDelay: 0, ReloadingDelay: 0, OverheatedDelay: 0, TrackingDelay: 0, LockedDelay: 0, OnDelay: 0, OffDelay: 0, BurstReloadDelay: 0, OutOfAmmoDelay: 0, PreFireDelay: 0),//Delay before animation starts
                    Reverse = Events(),
                ...
                new PartAnimationSetDef()
                {
                    SubpartId = Names("fenrir_door_04"), //Remember to remove subpart_ from these names!
                ...
                new PartAnimationSetDef()
                {
                    SubpartId = Names("fenrir_torp_04"), //Remember to remove subpart_ from these names!
                    BarrelId = "muzzle_missile_4", //Trigger anim when this muzzle does something.
                    StartupFireDelay = 0, //Delay in ticks until anim starts.
                    AnimationDelays = Delays(FiringDelay: 0, ReloadingDelay: 0, OverheatedDelay: 0, TrackingDelay: 0, LockedDelay: 0, OnDelay: 0, OffDelay: 0, BurstReloadDelay: 0, OutOfAmmoDelay: 0, PreFireDelay: 0),//Delay before animation starts
                    Reverse = Events(),
