...
namespace Scripts
{
    partial class Parts
    {
        WeaponDefinition AryxNovaBlasterSG => new WeaponDefinition
        {
            ...
            {
                PartName = "Nova Phase Blaster", // name of weapon in terminal
                ...
                {
                    PreFiringSound = "",
                    FiringSound = "ArcWepShipARYX_NovaBlasterFire", // WepShipGatlingShot
                ...
                Graphics = new HardPointParticleDef
                {
                    ...
                    {
                        Name = "Aryx_FW_NovaMuzzleFlash", // Smoke_LargeGunShot
