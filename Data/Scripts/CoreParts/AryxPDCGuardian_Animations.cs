...
namespace Scripts
{
    partial class Parts
    {
        private AnimationDef AryxGuardianAnims => new AnimationDef
        {
            ...
            EventParticles = new Dictionary<PartAnimationSetDef.EventTriggers, EventParticle[]>
            {
                [Firing] = new[]{
                       new EventParticle
                       {
                           EmptyNames = Names("recoil_compensator"),
                           ...
                           {
                               Name = "AWEGuardianGatlingRecoilCompensator",
                               Color = Color(red: 20, green: 20, blue: 25, alpha: 1),
                               Extras = new ParticleOptionDef
                               {
                                   Loop = true,
                                   Restart = true,
                                   MaxDistance = 700, //meters
                                   MaxDuration = 0.1f, //ticks 60 = 1 second
                                   Scale = 1,
                               }
                           }
                       },
