...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition AryxSentinelGun => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "ARYXSentinel",
            ...
            {
                PartName = "Sentinel Smartgun", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                {
                    RateOfFire = 675, // Set this to 3600 for beam weapons.
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "ArcWepShipARYXSentinel_Fire", // Audio for firing.
                    ...
                    BarrelRotationSound = "",
                    FireSoundEndDelay = 250, // How long the firing audio should keep playing after firing stops. Measured in game ticks(6 = 100ms, 60 = 1 seconds, etc..).
                },
            ...
            Ammos = new[] {
                AryxSmartAmmoWC, AryxSmartEnergyAmmoWC, // Must list all primary, shrapnel, and pattern ammos.
            },
