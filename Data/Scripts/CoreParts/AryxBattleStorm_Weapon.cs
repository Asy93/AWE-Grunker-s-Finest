...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition AryxStormCannon => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "ARYXStormCannon",
                        SpinPartId = "None",
                        MuzzlePartId = "None",
                        AzimuthPartId = "None",
            ...
            {
                PartName = "Storm Light Cannon", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
            ...
            Ammos = new[] {
                AryxStormAmmoWC, // Must list all primary, shrapnel, and pattern ammos.
                AryxKineticFrags,
            },
