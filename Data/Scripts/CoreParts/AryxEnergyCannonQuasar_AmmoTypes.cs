...
{ // Don't edit above this line
    partial class Parts
    {
        ...
        private AmmoDef BusterAryxQuasarAmmo => new AmmoDef
        {
            AmmoMagazine = "Energy", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo
            AmmoRound = "Bunker Buster Quasar Energy Bolt", // name of ammo in terminal, should be unique for each ammo type. Used for Name field in server config
            HybridRound = false, //AmmoMagazine based weapon with energy cost
            EnergyCost = 0.41991602f, //(((EnergyCost * DefaultDamage) * ShotsPerSecond) * BarrelsPerShot) * ShotsPerBarrel
