...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition AryxSpartanRifleSG => new WeaponDefinition
        {
            ...
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "ARYX_SpartanCannonSG",
                        SpinPartId = "None",
                        MuzzlePartId = "None",
                        AzimuthPartId = "None",
            ...
            {
                PartName = "Spartan Plasma Rifle", // name of weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons)
